    ...
    public function run()
    {
        ...
        $users = [
            ...
            [
                ...
                'role' => 'landlord',
                'is_subscribed' => true,
                'subscription_until' => $now->copy()->addMonths(6),
            ...
            [
                ...
                'role' => 'agent',
                'is_subscribed' => true,
                'subscription_until' => $now->copy()->addMonths(12),
            ...
            [
                ...
                'role' => 'tenant',
                'is_subscribed' => true,
                'subscription_until' => $now->copy()->addMonths(1),
            ...
            [
                ...
                'role' => 'investor',
                'is_subscribed' => true,
                'subscription_until' => $now->copy()->addYears(2),

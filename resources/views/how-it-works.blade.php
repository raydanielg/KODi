...
<body>
    ...
    <div class="container">
        ...
        <div class="role-selector">
            <button class="role-btn active" data-role="tenant">🏠 For Tenants</button>
            <button class="role-btn" data-role="landlord">🔑 For Landlords</button>
            <button class="role-btn" data-role="agent">🤝 For Agents</button>
        </div>
